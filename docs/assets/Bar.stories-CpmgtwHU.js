import{c as h,a as b}from"./utils-CiSxPhq7.js";import{d as v,c as B,w as _,n as x,u as r,o as C,r as I}from"./iframe-C7kf2e6L.js";import{P as w}from"./Primitive-eIKpGF7z.js";import{_ as u}from"./Button-CWLuhtfN.js";import{I as f}from"./Icon-BX1Hjp6F.js";import{_ as y}from"./index-B6qYo4L-.js";import"./ripple-CsoxYJ_M.js";const s=v({__name:"Bar",props:{dense:{type:Boolean,default:!1},class:{},asChild:{type:Boolean,default:!1},as:{default:"div"}},setup(e){const t=e;return(o,k)=>(C(),B(r(w),{as:t.as,asChild:t.asChild,class:x(r(h)(r(g)({dense:o.dense}),t.class))},{default:_(()=>[I(o.$slots,"default")]),_:3},8,["as","asChild","class"]))}});s.__docgenInfo={exportName:"default",displayName:"Bar",type:1,props:[{name:"asChild",global:!1,description:`Change the default rendered element for the one passed as a child, merging their props and behavior.\r
\r
...
\r
Read our [Composition](https://www.reka-ui.com/docs/guides/composition) guide for more details.`,declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"as",type:"string",description:"The element or component this component should render as. Can be overwritten by `asChild`.",declarations:[],schema:"string"},{name:"dense",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"class",type:"any",description:"",declarations:[],schema:"any"}],sourceFiles:"D:/Side Projects/shadcn-quasar/src/components/ui/bar/Bar.vue"};const g=b("relative flex flex-nowrap items-center bg-inherit text-inherit [&>button]:text-[11px] [&>button:not(:first-child)]:ml-0.5 [&>div:not(:first-child)]:ml-2 [&>i:not(:first-child)]:ml-2",{variants:{dense:{true:"h-6 px-2 py-0 text-sm",false:"h-8 px-3 py-0 text-lg"}},defaultVariants:{dense:!1}});g.__docgenInfo={exportName:"barVariants",displayName:"barVariants",type:2,props:[{name:"dense",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"class",global:!0,description:"",tags:[],required:!1,type:"ClassValue",declarations:[],schema:{kind:"enum",type:"ClassValue",schema:["string","number","bigint","false","true",{kind:"array",type:"ClassArray"},"ClassDictionary"]}},{name:"className",global:!1,description:"",tags:[],required:!1,type:"ClassValue",declarations:[],schema:{kind:"enum",type:"ClassValue",schema:["string","number","bigint","false","true",{kind:"array",type:"ClassArray"},"ClassDictionary"]}}],events:[],slots:[],exposed:[],sourceFiles:"D:/Side Projects/shadcn-quasar/src/components/ui/bar/index.ts"};const D={title:"UI/Bar",component:s,tags:["autodocs"]},a={render:e=>({components:{Bar:s,Button:u,Icon:f,Space:y},setup(){return{args:e}},template:`<Bar v-bind="args">${e.default}</Bar>`}),args:{class:"bg-primary text-primary-foreground",default:`
      <Button flat dense>
...
}`,...(m=(p=n.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};const R=["Basic","Dense"];export{a as Basic,n as Dense,R as __namedExportsOrder,D as default};
