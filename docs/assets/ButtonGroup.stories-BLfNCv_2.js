import{_ as a}from"./Button-DJR_z5yd.js";import{c as F,a as z}from"./utils-CiSxPhq7.js";import{d as N,a as D,w as j,n as A,u as c,o as E,b as K}from"./iframe-BMSNz29s.js";import{P as T}from"./Primitive-67GciMkc.js";import{I as U}from"./Icon-g_0tVZtb.js";import"./ripple-CsoxYJ_M.js";const n=N({__name:"ButtonGroup",props:{spread:{type:Boolean,default:!1},outline:{type:Boolean,default:!1},flat:{type:Boolean,default:!1},unelevated:{type:Boolean,default:!1},rounded:{type:Boolean,default:!1},square:{type:Boolean,default:!1},push:{type:Boolean,default:!1},glossy:{type:Boolean,default:!1},class:{},asChild:{type:Boolean,default:!1},as:{default:"div"}},setup(e){const p=e;return(t,H)=>(E(),D(c(T),{as:p.as,asChild:p.asChild,role:"group",class:A(c(F)(c(O)({spread:t.spread,outline:t.outline,flat:t.flat,unelevated:t.unelevated,rounded:t.rounded,square:t.square,push:t.push,glossy:t.glossy}),p.class))},{default:j(()=>[K(t.$slots,"default")]),_:3},8,["as","asChild","class"]))}});n.__docgenInfo={exportName:"default",displayName:"ButtonGroup",type:1,props:[{name:"as",global:!1,description:"The element or component this component should render as. Can be overwritten by `asChild`.",tags:[{name:"defaultValue",text:'"div"'}],required:!1,type:"string",declarations:[],schema:"string",default:'"div"'},{name:"asChild",global:!1,description:`Change the default rendered element for the one passed as a child, merging their props and behavior.\r
\r
...
\r
Read our [Composition](https://www.reka-ui.com/docs/guides/composition) guide for more details.`,declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"square",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"outline",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"push",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"flat",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"rounded",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"spread",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"unelevated",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"glossy",type:"boolean",description:"",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"class",type:"any",description:"",declarations:[],schema:"any"}],sourceFiles:"D:/Side Projects/shadcn-quasar/src/components/ui/buttonGroup/ButtonGroup.vue"};const O=z("relative inline-flex gap-0 whitespace-nowrap [&>*]:border-0 [&>*]:shadow-none [&>*]:active:transform-none [&>*]:active:shadow-none [&>*:not(:first-child)]:!rounded-l-none [&>*:not(:last-child)]:!rounded-r-none",{variants:{spread:{true:"[&>*]:w-auto [&>*]:max-w-full [&>*]:min-w-0 [&>*]:flex-[1000_1_0%]",false:""},outline:{true:"border border-current bg-transparent",false:""},flat:{true:"",false:""},unelevated:{true:"",false:""},rounded:{true:"rounded-full",false:"rounded-sm"},square:{true:"rounded-none",false:""},push:{true:"[&>*]:active:pt-0.75 [&>*]:active:pb-0.25 [&>*]:active:transition-[padding_.3s_cubic-bezier(.25,.8,.5,1)]",false:""},glossy:{true:"",false:""}},compoundVariants:[{flat:!1,unelevated:!1,outline:!1,push:!1,class:"shadow-md transition-shadow duration-300"}],defaultVariants:{spread:!1,outline:!1,flat:!1,unelevated:!1,rounded:!1,square:!1,push:!1,glossy:!1}});O.__docgenInfo={exportName:"buttonGroupVariants",displayName:"buttonGroupVariants",type:2,props:[{name:"spread",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"outline",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"flat",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"unelevated",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"rounded",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"square",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"push",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"glossy",global:!1,description:"",tags:[],required:!1,type:"boolean",declarations:[],schema:{kind:"enum",type:"boolean",schema:["false","true"]}},{name:"class",global:!0,description:"",tags:[],required:!1,type:"ClassValue",declarations:[],schema:{kind:"enum",type:"ClassValue",schema:["string","number","bigint","false","true",{kind:"array",type:"ClassArray"},"ClassDictionary"]}},{name:"className",global:!1,description:"",tags:[],required:!1,type:"ClassValue",declarations:[],schema:{kind:"enum",type:"ClassValue",schema:["string","number","bigint","false","true",{kind:"array",type:"ClassArray"},"ClassDictionary"]}}],events:[],slots:[],exposed:[],sourceFiles:"D:/Side Projects/shadcn-quasar/src/components/ui/buttonGroup/index.ts"};const Y={title:"UI/ButtonGroup",component:n,tags:["autodocs"]},s={render:e=>({components:{Button:a,ButtonGroup:n},setup(){return{args:e}},template:`
      <ButtonGroup v-bind="args">${e.default}</ButtonGroup>
    `}),args:{class:"",default:`
      <Button>Standard</Button>
      <Button>Standard</Button>
      <Button>Standard</Button>
    `}},o={render:e=>({components:{Button:a,ButtonGroup:n},setup(){return{args:e}},template:`
      <ButtonGroup v-bind="args">${e.default}</ButtonGroup>
    `}),args:{class:"",push:!0,default:`
      <Button push class="bg-cyan-600 text-white">Push</Button>
      <Button push class="bg-cyan-600 text-white">Push</Button>
      <Button push class="bg-cyan-600 text-white">Push</Button>
    `}},r={render:e=>({components:{Button:a,ButtonGroup:n,Icon:U},setup(){return{args:e}},template:`
      <ButtonGroup v-bind="args">${e.default}</ButtonGroup>
    ...
    `}},l={render:e=>({components:{Button:a,ButtonGroup:n},setup(){return{args:e}},template:`
      <ButtonGroup v-bind="args">${e.default}</ButtonGroup>
    `}),args:{class:"text-lime-600",outline:!0,default:`
      <Button outline class="text-lime-600">Outline</Button>
      <Button outline class="text-lime-600">Outline</Button>
      <Button outline class="text-lime-600">Outline</Button>
    `}},u={render:e=>({components:{Button:a,ButtonGroup:n},setup(){return{args:e}},template:`
      <ButtonGroup v-bind="args">${e.default}</ButtonGroup>
    `}),args:{class:"",rounded:!0,default:`
      <Button rounded class="bg-pink-600 text-white">Rounded</Button>
      <Button rounded class="bg-pink-600 text-white">Rounded</Button>
      <Button rounded class="bg-pink-600 text-white">Rounded</Button>
    `}},d={render:e=>({components:{Button:a,ButtonGroup:n},setup(){return{args:e}},template:`
      <ButtonGroup v-bind="args">${e.default}</ButtonGroup>
    `}),args:{class:"",flat:!0,default:`
      <Button flat class="text-red-600">Flat</Button>
      <Button flat class="text-red-600">Flat</Button>
      <Button flat class="text-red-600">Flat</Button>
    `}},i={render:e=>({components:{Button:a,ButtonGroup:n},setup(){return{args:e}},template:`
      <ButtonGroup v-bind="args">${e.default}</ButtonGroup>
