import{_ as e,a as Q,b as T}from"./index-BankAgfO.js";import{_ as u}from"./Badge-DIsic-ra.js";import{I as p}from"./Icon-DM8DZhqr.js";import"./index-CTWEWApt.js";import"./utils-DheDpAxB.js";import"./iframe-C1nf-jxf.js";import"./Primitive-lODkUz4w.js";const ta={title:"UI/Avatar",component:e,tags:["autodocs"]},r={render:a=>({components:{Avatar:e},setup(){return{args:a}},template:`<Avatar v-bind="args">${a.default}</Avatar>`}),args:{class:"bg-primary text-primary-foreground",default:"J"}},t={render:a=>({components:{Avatar:e},setup(){return{args:a}},template:`<Avatar v-bind="args">${a.default}</Avatar>`}),args:{class:"bg-blue-500 text-white",default:"J"}},n={render:a=>({components:{Avatar:e},setup(){return{args:a}},template:`<Avatar v-bind="args">${a.default}</Avatar>`}),args:{class:"bg-primary text-primary-foreground",rounded:!0,default:"J"}},s={render:a=>({components:{Avatar:e},setup(){return{args:a}},template:`<Avatar v-bind="args">${a.default}</Avatar>`}),args:{class:"bg-primary text-primary-foreground",square:!0,default:"J"}},o={render:a=>({components:{Avatar:e,Icon:p},setup:()=>({args:a}),template:`
      <Avatar v-bind="args">
        ${a.default}
      </Avatar>
...
}`,...(f=(A=r.parameters)==null?void 0:A.docs)==null?void 0:f.source}}};var b,x,h;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => ({
    components: {
      Avatar
    },
...
}`,...(h=(x=t.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};var I,B,y;n.parameters={...n.parameters,docs:{...(I=n.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => ({
    components: {
      Avatar
    },
...
}`,...(y=(B=n.parameters)==null?void 0:B.docs)==null?void 0:y.source}}};var $,z,w;s.parameters={...s.parameters,docs:{...($=s.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: args => ({
    components: {
      Avatar
    },
...
}`,...(P=(N=m.parameters)==null?void 0:N.docs)==null?void 0:P.source}}};const na=["Basic","BasisCustomColors","Rounded","Square","WithIcon","WithBadge","WithIconAndBadge","WithSimpleImg","WithImgFallback","WithImgFallbackAndBadge","CustomSize"];export{r as Basic,t as BasisCustomColors,m as CustomSize,n as Rounded,s as Square,d as WithBadge,o as WithIcon,c as WithIconAndBadge,g as WithImgFallback,i as WithImgFallbackAndBadge,l as WithSimpleImg,na as __namedExportsOrder,ta as default};
