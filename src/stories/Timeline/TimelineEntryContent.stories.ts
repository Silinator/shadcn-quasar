...
const meta: Meta<typeof TimelineEntryContent> = {
  title: 'UI/Timeline/TimelineEntryContent',
  component: TimelineEntryContent,
  tags: ['autodocs'],
};
    ...
    template: `
      <Timeline>
        <TimelineEntry>
          ...
          <TimelineEntryContent v-bind="args">${args.default}</TimelineEntryContent>
        </TimelineEntry>
